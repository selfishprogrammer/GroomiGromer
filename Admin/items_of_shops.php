...
$shop_id1=$_GET['shop_id'];
                    $sql = "select * from `items` where `shop_id`='$shop_id1'";
...
<td style="color:white; font-family: math;"><a href="verify.php?item_id=' . $row['item_id'] . '&shop_id='.$shop_id1.'" class="btn btn-success" style="width:10rem;">Verify Shops</a></td>
</tr>';
                        }
