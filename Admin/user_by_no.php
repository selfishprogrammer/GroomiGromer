        ...
        <form action="<?php $_SERVER['REQUEST_URI'] ?>" class="p-3" method="post">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="form-group">
                    <input type="number" name="phone" placeholder="Enter Phone No" class="form-control"
                        style="width:100%; font-family: cursive;" id="">
                </div>
                <div class="d-flex justify-content-center">
                    <div class="form-group">
                        <button type="submit" name="phone_submit" class="btn btn-warning form-control" style="width: 18rem;">
                            SEARCH
                        </button>
                    </div>
                </div>
...
<td style="color:white; font-family: math;"><a href="view_bookings_of_user.php?user_id=' . $row['user_id'] . '" class="btn btn-success" style="width:10rem;">View Bookings</a></td>
</tr>';
