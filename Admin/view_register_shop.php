        ...
        <div class="shadow-sm" style="overflow-x: auto;">
            <table class="table table-bordered">
                ...
                <tr style="background-color:black; font-family: math; color:white;">
                        ...
                        <th style=" font-family: math; color:white;">Delete Shop</th>
                        <th style=" font-family: math; color:white;">View Items</th>
                        <th style=" font-family: math; color:white;">View TimeSlot</th>
...
<td style=" font-family: math; color:black"><a href="shop_update?shop_id=' . $row['shop_id'] . '" class="btn btn-warning" style="width:10rem;">Update Shop</a></td>
<td style=" font-family: math; color:black"><a href="shop_delete?shop_id=' . $row['shop_id'] . '" class="btn btn-danger" style="width:10rem;">Delete Shop</a></td>
...
<td style=" font-family: math; color:black"><a href="shop_details_by_id?shop_id=' . $row['shop_id'] . '" class="btn btn-secondary" style="width:10rem;">View Bookings</a></td>
