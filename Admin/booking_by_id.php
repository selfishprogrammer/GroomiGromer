        ...
        <form action="<?php $_SERVER['REQUEST_URI'] ?>" class="p-3" method="post">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="form-group">
                    <input type="number" name="booking_id" placeholder="Enter Booking ID" class="form-control" style="width:100%; font-family: cursive;" id="">
                </div>
                <div class="d-flex justify-content-center">
                    <div class="form-group">
                        <button type="submit" class="btn btn-warning form-control" style="width: 18rem;">
                            SEARCH
                        </button>
                    </div>
                </div>
...
$booking_id=$_POST['booking_id'];
                    $sql = "select * from `booking_renter` where `booking_id`='$booking_id'";
