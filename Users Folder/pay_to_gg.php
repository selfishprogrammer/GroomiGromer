                ...
                <div class="shadow-sm my-2 border fixed-bottom" style="border-radius:10px;" >
                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn-default border form-control my-2 mx-2"
                            style="font-family:math; font-size:20px;background-color:white; width:20rem;" disabled>Pay To GG</button>
                        <button type="" class="btn form-control my-2 mx-2"
                            ...
                            style="font-family:math; font-size:20px;background-color:yellowgreen ; width:20rem;" id="total_earn"> <i
                                class="fa fa-inr" aria-hidden="true"></i>&nbsp;<?php echo $total_comision?>&nbsp;<i
                                class="fa fa-angle-down" aria-hidden="true"></i></button>
                    </div>

                    <div class="card" id="payment_page" style="display:none">
                        <div class="card-header text-center bg-info" style="font-size:20px; font-family:math">PAY TO GG</div>
                        ...
                        <div class="d-flex justify-content-between my-3">
                            ...
                            <div class="d-flex justify-content-between my-3">
                                <div class="text-center" style="font-size:25px; font-family:math;">Amount To Pay :</div>
                                <div class="text-center" style="font-size:25px; font-family:math;"><i
                                class="fa fa-inr" aria-hidden="true"></i>&nbsp;<?php  echo $total_comision   ?></div>


                            </div>

                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-outline-info form-control" style="width:18rem;" >Pay Now</button>
