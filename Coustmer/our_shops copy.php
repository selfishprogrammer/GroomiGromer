    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="shadow-sm mb-3" style="width: 300px; height:450px; border-radius: 10px;">
                    <img src="../Admin/Shops Image/<?php echo $row['img_1'] ?>" width="100%" height="200px" alt="" class="card-img">
                    <div class="text-center my-2" style="font-size: 20px;  font-family: 'Lobster', cursive;"><?php echo $row['shop_name'] ?></div><hr>
                   ...
                   <div class="text-center"></div>
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-info  " style="width: 16rem;">View More</button>
                    </div>
                </div>
            </div>
            <?php } ?>
